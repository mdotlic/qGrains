...
void DrillChooser::addDrillPersistent(const int & idrill)
{
...
void DrillChooser::deleteDrillPersistent(const int & idrill)
{
   _table->closePersistentEditor( _viewHandler->index(idrill, 1, _viewHandler->index(ModelEnums::Root::CHECKS, 0)) );
}

void DrillChooser::remakePers()
{

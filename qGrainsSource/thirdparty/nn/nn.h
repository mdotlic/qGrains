 ...
 */
void nnai_interpolate(nnai* nn, const double* zin, double* zout);
void nnai_interpolate_flex(nnai* nn, const double* zin, double* zout, const unsigned int zinWidth, const unsigned int dimension);
...
int numberofsegments (delaunay* d);
int *segmentlist (delaunay* d);

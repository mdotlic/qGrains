...
public:
  ...
  */
  enum LineStyle { lsNone        ///< data points are not connected with any lines (e.g. data only represented
                   ...
                   ,lsControlImpulse ///<each 2 data point gives a line parallel to the value axis MDotlic
                 };
  Q_ENUMS(LineStyle)
...
protected:
  ...
  QVector<QPointF> dataToControlImpulseLines(const QVector<QCPGraphData> &data) const;
